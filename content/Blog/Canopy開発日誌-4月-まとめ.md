...
modified: 2026-07-16T10:40:00+09:00
---
...
`LanguageCapabilities[T]`によって、`SyncEditor`からLambda固有の型が切り離された。Lambdaが唯一の言語だという前提を置かない、汎用的なtree opへの道が開かれた――これが後にJSON・Markdown、そして7月のJSXへとつながっていく下地になる。
